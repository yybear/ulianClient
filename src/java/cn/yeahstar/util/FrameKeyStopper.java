 ...
 * @author ganqing
 */
public class FrameKeyStopper implements Runnable {
    ...
    public FrameKeyStopper(JFrame frame) {
        this.frame = frame;
    }
    ...
    public static FrameKeyStopper create(JFrame frame) {
        FrameKeyStopper stopper = new FrameKeyStopper(frame);
